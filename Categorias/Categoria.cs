       ...
       private void Eliminar_Click(object sender, EventArgs e)
        {
            ...
            var de = BLL.PeliculaBLL.Buscar (Convert.ToInt32(IdtextBox1.Text)) ;

            if (de != null)
            {
                BLL.PeliculaBLL.Elimina(de);
        ...
        {
            var bus= BLL.PeliculaBLL.Buscar(Convert.ToInt32(IdtextBox1.Text));
